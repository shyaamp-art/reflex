      ...
      <div className="flex items-center space-x-3">
        ...
        <div className="flex items-center space-x-2.5 rounded-xl border border-slate-200 bg-slate-50/80 px-3 py-1.5">
          ...
          <div className="hidden text-xs sm:block">
            <p className="font-semibold leading-tight text-slate-900">{currentUser.name}</p>
            <p className="text-[10px] font-medium uppercase tracking-wide text-indigo-600">{currentUser.role}</p>
          </div>
        </div>
      </div>
    </header>
